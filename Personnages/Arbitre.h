...
{
public:
	Arbitre(std::string p_nom = "", string p_lieu_obtention = "", int p_experience = 0);
	Arbitre(std::string p_nom, string p_lieu_obtention, int p_expérience, uint8_t p_age, std::string p_ville = "");
	Arbitre(std::string p_nom, std::string p_prenom = "", string p_lieu_obtention = "", int p_experience = 0, uint8_t p_age = 0, std::string p_ville = "", float p_taille = 0., float p_poids = 0.);
	virtual ~Arbitre();

	void set_lieu_experience(string p_lieu_obtention) { m_lieu_obtention = p_lieu_obtention; };
	void set_experience(int p_experience) { m_experience = p_experience; };

	string get_lieu_obtention() { return m_lieu_obtention; };
	int get_experience() { return m_experience; };
